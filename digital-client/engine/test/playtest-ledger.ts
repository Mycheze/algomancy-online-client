  ...
  },
{
  ...
  },
  {
    ...
    status: 'live',
    note:
      'CONFIRMED against printed.json. Oracle of Foretelling reads "Glimpse 5 (Reveal the top '
      + 'five cards of the deck and cache one. Until end of turn, you may play it as if it was '
      + 'in your hand, ignoring affinity)" — and stops. Premonition, Celestial Purge, '
      + 'Dematerialize and Foretell all read the same way. The ENGINE recycles the rest to the '
      + 'bottom of the deck, which is R45 as corrected on 2026-08-19, and the glimpse log line '
      + 'says so out loud. '
      + '⚠ THIS IS A DATA FIX UPSTREAM, NOT A CODE FIX, and that is the whole difficulty: '
      + 'printed.json is GENERATED by scripts/extract-printed.mjs from AlgomancyCards-OracleText'
      + '.json, so a hand edit is wiped on the next regeneration. Same shape as Might of the '
      + 'Grove, Interdiction Rift and Arbiter of Armistice\'s {Switch} — the RAG corpus and the '
      + 'Discord bot read the ORACLE file directly, so they are wrong about this too until it is '
      + 'fixed at source. One message to Caleb fixes it everywhere; an extractor override fixes '
      + 'it in one of the three places. Carried as CT-71.',
  },
];
