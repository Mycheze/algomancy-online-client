 ...
 *
 * Served over HTTP the page is at `/index.html`, so `../../../AlgomancyCards/`
 * resolves to `/AlgomancyCards/…` — the excess `..` clamps at the root — and
...
export const ART_BASE = '../../../AlgomancyCards/';
