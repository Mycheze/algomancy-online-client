...
import { activationKeys } from '../inspect.ts';
...
import { modHostPhrase, modHosts, spellAugmentNote } from '../inspect.ts';
...
const INSPECT = readFileSync(new URL('../inspect.ts', import.meta.url), 'utf8');
