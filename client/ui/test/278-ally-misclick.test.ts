...
import { effectByKey, getCard, mixedAllegiance, slotWhat, type TargetSpec } from '../../engine/src/cards/dsl.ts';
...
import type { DecisionOption, Seat } from '../../engine/src/types.ts';
