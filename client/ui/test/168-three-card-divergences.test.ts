...
import { E, other } from '../../engine/src/engine.ts';
import { createGame, legalActions } from '../../engine/src/apply.ts';
...
import { numberEntry, numberEntrySubmit, stepNumberEntry } from '../inspect.ts';
