...
const TERMS: RulesSection = {
  ...
  entries: [
    ...
    { title: 'Cache', body: 'Place the card in a temporary zone. Cached cards are public: both players can see them. Being cached is not permission to use a card — only an effect that says so, such as a fulfilled prophecy or a glimpse this turn, lets you. That permission covers playing, augmenting and grafting alike, and when it lapses the card stays in the cache doing nothing.', source: 'Player Keywords help card' },
