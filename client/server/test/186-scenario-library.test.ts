...
import type { Action, CardName, Element, GameState, Seat } from '../../engine/src/types.ts';
...
import {
  OPPONENT, SCENARIOS, YOU, dealScenario, passiveMove, printedClauses, scenarioIds, BATCHES } from '../scenarios.ts';
import { analyze, type RoomFile } from '../replay-room.ts';
import { probe } from '../replay-probe.ts';
